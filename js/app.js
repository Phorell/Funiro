    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".hero__slider")) new swiper_core_Swiper(".hero__slider", {
                ...
                lazy: true,
                pagination: {
                    el: ".controls-slider-hero__dotts",
                    clickable: true
                },
                navigation: {
                    prevEl: ".hero__inner .slider-arrow--prev",
                    nextEl: ".hero__inner .slider-arrow--next"
                }
            });
            if (document.querySelector(".slider-rooms__slider")) new swiper_core_Swiper(".slider-rooms__slider", {
                modules: [ Navigation, Pagination, Parallax ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".slider-tips__slider")) new swiper_core_Swiper(".slider-tips__slider", {
...
***************************************************************************** */
        ...
        window.onload = function() {
            ...
            const furniture = document.querySelector(".furniture__content");
